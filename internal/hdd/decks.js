...
//
// Modified by Menci for Chinese l10n
...
var deckDecoder = function() {
	...
	var lookup = fetch('./cards.collectible.json')
	...
	var resolve = function(deck, lookup) {
		...
		return {heroClass: cardClasses[lookup[deck.hero].cardClass], type: (deck.type === 1 ? "狂野" : "标准"), hero: lookup[deck.hero], cards: cards};
	};
	...
	return {decode: function(encoded) { return lookup.then(function(mapping) { return resolve(deck(encoded), mapping); }); }};
};
